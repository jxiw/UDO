...
# cursor.execute("set shared_buffers = 94720MB")
# cursor.execute("set effective_cache_size = 284160MB")
# cursor.execute("set maintenance_work_mem = 2GB")
# cursor.execute("set checkpoint_completion_target = 0.7")
...
# cursor.execute("set work_mem = 121241kB")
# cursor.execute("set min_wal_size = 1GB")
# cursor.execute("set max_wal_size = 4GB")
# cursor.execute("set max_worker_processes = 32")
