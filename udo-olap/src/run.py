...
if args['indices']:
    ...
    with open(args['indices']) as f:
        ...
        for index_str in indices:
            ...
            index.candidate_indices.append((index_information[0], index_information[1], index_information[2]))
...
if args['agent'] == 'udo':
    ...
    run_udo_agent(duration=args['duration'], heavy_horizon=heavy_horizon, light_horizon=(horizon - heavy_horizon),
