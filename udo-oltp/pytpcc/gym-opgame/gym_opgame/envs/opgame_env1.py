...
#
#         self.payment_permutation_to_position = {''.join([chr(x) for x in value]): key for key, value in
...
#
#         self.delivery_permutation_to_position = {''.join([chr(x) for x in value]): key for key, value in
...
#
#         self.new_order_permutation_to_position = {''.join([chr(x) for x in value]): key for key, value in
...
#         self.parameter_candidate = [3, 4, 4, 4]
...
#         # print self.nS
#         # print self.nA_reorder_payment
#         # print self.nA_reorder_delivery
#         # print self.nA_reorder_new_order
#         # print self.nA_index
#         # print self.nA_parameter
#         # print self.nA
#
...
#
#         #map order to procedure indentifier
#         invoke_payment_proc = self.payment_permutation_to_position[''.join([chr(x) for x in invoke_payment_order])]
#         invoke_new_order_proc = self.new_order_permutation_to_position[''.join([chr(x) for x in invoke_new_order_order])]
#         invoke_delivery_proc = self.delivery_permutation_to_position[''.join([chr(x) for x in invoke_delivery_order])]
#
#         # invoke transaction reorder
#         proc_Info = {"payment_order": invoke_payment_proc, "delivery_order": invoke_new_order_proc, "new_order_order": invoke_delivery_proc}
#
#         print(proc_Info)
