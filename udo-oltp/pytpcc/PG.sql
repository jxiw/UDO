...
CREATE TABLE ITEM (
  ...
  I_PRICE DOUBLE PRECISION DEFAULT NULL,
...
CREATE TABLE CUSTOMER (
  ...
  C_SINCE TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP NOT NULL,
  C_CREDIT VARCHAR(2) DEFAULT NULL,
  C_CREDIT_LIM DOUBLE PRECISION DEFAULT NULL,
  C_DISCOUNT DOUBLE PRECISION DEFAULT NULL,
  C_BALANCE DOUBLE PRECISION DEFAULT NULL,
  C_YTD_PAYMENT DOUBLE PRECISION DEFAULT NULL,
...
CREATE TABLE HISTORY (
  ...
  H_DATE TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP NOT NULL,
  H_AMOUNT DOUBLE PRECISION DEFAULT NULL,
...
CREATE TABLE ORDERS (
  ...
  O_ENTRY_D TIMESTAMP(0) DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE ORDER_LINE (
  ...
  OL_DELIVERY_D TIMESTAMP(0) DEFAULT NULL,
  OL_QUANTITY INTEGER DEFAULT NULL,
  OL_AMOUNT DOUBLE PRECISION DEFAULT NULL,
...
CREATE TABLE  HISTORY_COPY AS TABLE HISTORY;
CREATE TABLE NEW_ORDER_COPY AS TABLE  NEW_ORDER;
CREATE TABLE ORDER_LINE_COPY AS TABLE ORDER_LINE ;
CREATE TABLE ORDERS_COPY AS TABLE  ORDERS;
CREATE TABLE CUSTOMER_COPY AS TABLE CUSTOMER ;
CREATE TABLE DISTRICT_COPY AS TABLE  DISTRICT;
CREATE TABLE STOCK_COPY AS TABLE  STOCK;
CREATE TABLE ITEM_COPY  AS TABLE ITEM ;
CREATE TABLE WAREHOUSE_COPY  AS TABLE WAREHOUSE;
